{
  ...
  programs.hyprpanel.settings.theme = with config.lib.stylix.colors.withHashtag; let
    # Helper function to recursively apply mkForce to all values in an attribute set
    forceAll = attrs:
      lib.mapAttrs (
        _: value:
